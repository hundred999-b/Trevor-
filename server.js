...
app.use((req, res, next) => {
  res.setHeader('Content-Security-Policy',
    ...
    "connect-src 'self' https://api.hyperliquid.xyz https://api.binance.com https://fapi.binance.com https://api.coingecko.com https://trevor-mr20.onrender.com; " +
    "frame-src 'self'; " +
...
const allowedOrigins = [
  ...
  'https://hyperliquid-community.vercel.app',  // Add your actual frontend domain
  'https://hyperliquid-community.netlify.app'
];
...
// Also add a simple CORS preflight handler for all routes
